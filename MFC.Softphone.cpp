...
// MFC.Softphone.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CMFCSoftphoneApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CMFCSoftphoneApp

CMFCSoftphoneApp::CMFCSoftphoneApp()
{
...
// Único objeto CMFCSoftphoneApp

CMFCSoftphoneApp theApp;


// Inicialización de CMFCSoftphoneApp

BOOL CMFCSoftphoneApp::InitInstance()
{
